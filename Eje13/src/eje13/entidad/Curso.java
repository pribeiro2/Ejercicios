...
public class Curso {
    ...
    private String[] alumnos = new String[5]; // no se dimensiona. Limitar en la carga.
//private Alumnos[] A1;

    public Curso() {
        nombreCurso = null;
        cantidadHorasPorDia = 0;
        cantidadDiasPorSemana = 0;
        turno = null;
        precioPorHora = 0;
        for (int i = 0; i < 5; i++) {
            alumnos[i] = null;
    ...
    public void setAlumnos(String alumnos, int i) {
